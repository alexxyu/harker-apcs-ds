...
public class BoardDisplay implements ActionListener
{
    ...
    /**
     * Enables or disables the BoardDisplay's highlighting of the board
     * based on whose turn it is. For example, when it is the opposing player's
     * turn, the user should not be able to highlight any squares.
     * 
     * @param highlight whether or not to highlight squares
     */
    public void enableOrDisableHighlights(boolean highlight)
    {
