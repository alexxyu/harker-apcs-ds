...
public class Location implements Comparable
{
    ...
    /**
     * Gets the adjacent location in any one of the eight compass 
     * directions.
     * 
    ...
    /**
     * Returns the direction from this location toward another 
     * location. The direction is rounded to the nearest 
     * compass direction.
     * 
     ...
     *                           <code>Location</code> with the same 
     *                           row and column as this location;
     *                           otherwise
     *         <code>false</code> 
     */
     ...
     * as this location is less than, equal to, or greater than 
     * <code>other</code>. Locations are ordered in row-major 
     * order.
     * 
     * @precondition <code>other</code> is a <code>Location</code> 
     *               object
     * @param other  the other location to test
