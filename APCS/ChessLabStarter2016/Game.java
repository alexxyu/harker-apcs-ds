...
public class Game
{
    ...
    public Game()
    {
        ...
        play(new HumanPlayer(display, board, "Alex", Color.BLACK), 
             new SmartPlayer(board, "Smart Player", Color.WHITE));
    }
    ...
    public void play(Player black, Player white)
    {
        while(!gameOver)
        {
            ...
            display.setTitle(black.getName() + "'s turn");
            nextTurn(black);
    ...
    {
        new Game();
        //RandomPlayer player = new RandomPlayer(board, "Alex", Color.BLACK);

        //play(board, display, new RandomPlayer(board, "Alex", Color.BLACK), new RandomPlayer(board, "John", Color.WHITE));
        //play(board, display, new HumanPlayer(display, board, "Alex", Color.BLACK), new RandomPlayer(board, "AI", Color.WHITE));
        //play(board, display, new HumanPlayer(display, board, "Alex", Color.BLACK), new HumanPlayer(display, board, "John", Color.WHITE));
        //play(board, display, new HumanPlayer(display, board, "Alex", Color.BLACK), new SmartPlayer(board, "Smart Player", Color.WHITE));
    }
}
